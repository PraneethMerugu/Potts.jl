...
heavy computation occurs. Phase 16.A has qualified the dependency, extension, API, and checker
boundary; the 28 requirements in 16.B through 16.I and internal-beta closure remain fail-closed.
