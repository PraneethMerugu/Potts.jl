...
| [Phase 14 Single Semantic Kernel](phase-14-semantic-kernel.md) | `scripts/check_phase14_0.jl`, registry v2, Decisions 0031/0032, the [GPU-native plan](../design/audits/phase-14-gpu-native-implementation-plan.md), simplification audit, accepted 15-question interview, six-model lowering sketches, D9/Morpheus traceability matrices, and the [Wortel vertical-slice evidence](../design/audits/phase-14-wortel-vertical-slice-evidence.md) | Seven-area architecture accepted; Wortel Act CPU-reference slice, façade equivalence, continuation, observation, inspection, and preflight passed; contracts remain Provisional beyond that slice | Wortel backend-resident real-hardware Metal/ROCm closure, then Wang CPU plus Metal/ROCm, then one field model through the same gate; published-model reproduction evidence remains separate |
