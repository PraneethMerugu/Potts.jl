...
| [Phase 14 Single Semantic Kernel](phase-14-semantic-kernel.md) | `scripts/check_phase14_0.jl`, registry v2, Decisions 0031–0033, the [GPU-native plan](../design/audits/phase-14-gpu-native-implementation-plan.md), semantic and [generic authoring](../design/audits/phase-14-generic-authoring-simplification-audit.md) simplification audits, accepted 15-question interview, D9/Morpheus traceability matrices, [Wortel CPU/Metal/ROCm evidence](../design/audits/phase-14-wortel-vertical-slice-evidence.md), the [Wang source/runtime order oracle](../design/audits/phase-14-wang-order-audit.md), and the [G3-B closure specification audit](../design/audits/phase-14-g3b-closure-spec-audit.md) | Seven-area architecture and generic hierarchical authoring accepted; Wortel Act G2 passed; Wang Potts/field/Python order, source-MCS-to-target-MCS `k -> k+1` mapping, and source 120/210/211 (target 121/211/212) visibility accepted; contracts remain Provisional beyond proven slices | Implement the revision-2 G3-B field/exchange transaction and remaining Wang primitives, close sequential CPU plus runtime oracles, then qualify the identical canonical model on Metal and ROCm; published-model reproduction evidence remains separate |
