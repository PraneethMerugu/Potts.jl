# Historical Specification-to-Conformance Evidence Index

Status: historical baseline; not current qualification authority

Captured maturity: Phase 13 complete; Phase 14 G3-B complete; early Symbolic Potts V1

This file preserves the earlier specification-to-evidence map. Paths, public APIs, maturity labels,
and backend claims may describe a removed or changed implementation and must not be treated as
exact-head qualification. G5H-0 creates a current preservation map, and touched claims require
fresh evidence under the G5H reviews.
...
| [Phase 14 Single Semantic Kernel](phase-14-semantic-kernel.md) | `scripts/check_phase14_0.jl`, `scripts/check_phase14_g3b_closure.jl`, `scripts/check_phase14_wang_disposition.jl`, registry v2, Decisions 0031–0033 and 0035, the [GPU-native plan](../design/audits/phase-14-gpu-native-implementation-plan.md), semantic and [generic authoring](../design/audits/phase-14-generic-authoring-simplification-audit.md) simplification audits, D9/Morpheus traceability matrices, [Wortel CPU/Metal/ROCm evidence](../design/audits/phase-14-wortel-vertical-slice-evidence.md), the [Wang source/runtime order oracle](../design/audits/phase-14-wang-order-audit.md), and the [passed G3-B closure ledger](../design/audits/phase-14-g3b-closure-ledger-v1.toml) | Wortel Act G2 and Wang G3-B sequential CPU closure passed; assembled Wang GPU qualification retired; contracts remain Provisional beyond proven slices | Published-model reproduction and additional backend evidence remain separate |
...
provenance is implemented through CorePotts and Potts interfaces in later phases.
