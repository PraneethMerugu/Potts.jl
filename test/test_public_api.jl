@testset "authoritative public API inventory" begin
    expected = Set(
        Symbol[
            ...
            :ForbidExtinction, :Periodic, :Closed, :FixedExterior, :AxisBoundary,
            :Obstacle, :MediumDomainOwner, :WallDomainOwner, :VonNeumann,
    ...
    retired = Set(
        (
            ...
            :CUDABackend, :ROCmBackend, :FrozenBorder,
...
@testset "curated public help is attached and truthful" begin
    ...
    native_component_help = sprint(
        show, MIME"text/plain"(),
        Docs.doc(NativeComponent)
    )
    solve_profile_help = sprint(
        show, MIME"text/plain"(),
