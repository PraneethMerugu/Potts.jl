...
This program deliberately uses the named `DiscreteFieldEuler()` component.
It does not imply a generic PDE-solver claim; the separate checked
MethodOfLines row is documented in [Fields, batching, and ensembles](@ref
