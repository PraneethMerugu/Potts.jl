...
| PR15 | replaced | Final black-box Wortel, Merks, and focal witnesses plus complete serial Wortel/Merks reusable programs execute. Independent R2H-C confirmed that Wortel's site/copy/MCS activity is intrinsically CPM-owned and Merks' moving-occupancy secretion is incompatible with the qualified output-only MethodOfLines adapter; the published pages record the exact dispositions. No G7 scientific claim is made. |
...
| PR27 | replaced | Base `ModelingToolkitBase.mtkcompile(::PottsSystem)`, full-MTK retained native islands, MTKStandardLibrary, Catalyst conversion, and checked MethodOfLines extension replace lossy equation assimilation. `EquationProcess` is removed rather than retained as a second equation authority. Independent R2H-C confirmed that MTK owns equations, hierarchy, and connections internal to native systems while PottsToolkit owns only the typed CPM boundary. |
...
only after a fresh R2H-C rereview clears that exact candidate. The final fresh
rereview cleared implementation candidate
`06741e681cc1a5cacbbc4f56ac8a412401e4ee52`, tree
`19a8ca73145412b0efa060845ae56fd929605a19`, against qualification record
`f3e527cf1bb1c083574fd682b6fd4576ebccf120`, tree
`6b6701159a425de2c1c6832d935b75bb26b0d8a7`, with P0=0, P1=0, P2=0, and
P3=0. This preservation closure is passed.
