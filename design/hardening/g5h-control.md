...
ED-R0 passed; LW-5 open; G6 closed
...
| LocalWorksets LW-5 through LW-R3 | `open` | ED-R0 cleared the pre-adoption hold. Begin with the existing representability inventory and one evidence-bearing pilot; domain semantics remain in PottsToolkit/CorePotts. Further migration depends on smaller adapters, clearer authoring/inspection, parity, allocation, launch, and CPU/Metal evidence. |
