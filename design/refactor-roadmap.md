...
4. **G3-A complete; G3-B current with implementation entry frozen.** The Decision 0033 generic
   ...
   device-ready storage, numerical profiles, conformance matrix, and remaining runtime oracles.
