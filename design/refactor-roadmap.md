...
| Phase 16: Engine/Field Protocol, Absorbed G4, Dynamic Hierarchy, CorePotts Adapter, and Runnable Merks/CNV Internal Beta | In progress; 16.A/B/D/E/F qualified, 16.C hardware and 16.G–I open | Decision 0039, qualified engine/field/structure/CorePotts/real-SciML evidence, and the entry, qualification, backend, migration, model, and API registries agree |
