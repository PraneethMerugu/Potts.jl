...
| Phase 16: Engine/Field Protocol, Absorbed G4, Dynamic Hierarchy, CorePotts Adapter, Runnable Merks/CNV, and High-Level Composition Internal Beta | In progress; 16.A–HC qualified, 16.I open | Decisions 0039/0040, qualified CPU/Metal/ROCm engine/field evidence, structure/CorePotts/real-SciML/Merks/CNV/high-level-authoring evidence, and the entry, qualification, backend, migration, model, and API registries govern |
