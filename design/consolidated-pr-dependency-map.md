...
| **C10 Cartesian domain ownership** | CorePotts | G05 | G04 merge gate; implementation base Core R08 | R10 Core spatial-query maintenance and C11 Potts domain lowering | Merged as `b6ded93d`; full hosted CPU/docs/macOS/real-Metal green, followed by focused device correction PR38 `2ceb98ac` | [CorePotts PR35](https://github.com/PraneethMerugu/CorePotts.jl/pull/35) |
| **C11 Cartesian domain authoring** | Potts | G05 | C10, R09 | R11 complete spatial-query authoring and lowering | Merged as `7bfc2d30`; full local owner CPU/docs/integration/replay/real-Metal and required hosted package/docs/macOS/integration/replay/real-Metal green; merge tree equals qualified tip `43f293c3` | [Potts PR59](https://github.com/PraneethMerugu/Potts.jl/pull/59) |
