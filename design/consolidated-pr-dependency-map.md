...
| **C11 Cartesian domain authoring** | Potts | G05 | C10, R09 | R11 complete spatial-query authoring and lowering | Local clean restack `064231eb` with focused Cartesian tests 106/106; rebase onto merged R09 and full qualification pending | [Potts PR59](https://github.com/PraneethMerugu/Potts.jl/pull/59) |
